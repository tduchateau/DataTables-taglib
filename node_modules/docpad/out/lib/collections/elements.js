...
(function() {
  var Collection, ElementsCollection, Model, _, _ref,
  ...
  ElementsCollection = (function(_super) {
    ...
    ElementsCollection.prototype.add = function(values, options) {
      ...
      return ElementsCollection.__super__.add.call(this, values, options);
    };
